 ...
 */
@Component
public class WalletOperationAdapterOld /*implements WalletOperationPort*/ {
    ...
    public WalletOperationAdapterOld(
        RestClient.Builder restClientBuilder,
        @Value("${villagesat.services.wallet-url}") String walletUrl,
        @Value("${villagesat.services.transaction-url}") String transactionUrl,
